 ...
 */
export function trySplit(player, blob, targetX, targetY) {
    const now = Date.now();
    // Check cooldown
 ...
 */
export function processMerging(player) {
 ...
 */
function mergeBlobs(survivor, absorbed) {
    // Combine mass
 ...
 */
export function trySplitAll(player, targetX, targetY) {
    let anySplit = false;
